...
import LaurenFarmerImg from "@/assets/AboutPage/team/Lauren Farmer.webp";
import KoyaliBurmanImg from "@/assets/AboutPage/team/Koyali Burman.webp";
import JuanSebastianMateusImg from "@/assets/AboutPage/team/Juan Sebastian Mateus.webp";
import RosioGodomarImg from "@/assets/AboutPage/team/Rosio Godomar.webp";
import JessicaSteeleImg from "@/assets/AboutPage/team/Jessica Steele.webp";
import PatsyGeorgeImg from "@/assets/AboutPage/team/Patsy George.png";
import SoonLanLeeSwitzerImg from "@/assets/AboutPage/team/Soon-Lan Lee Switzer.webp";
import SalmaHusainImg from "@/assets/AboutPage/team/Salma Husain.webp";
import GeorgeSomerwillImg from "@/assets/AboutPage/team/George Somerwill.webp";
import NadiaLeviImg from "@/assets/AboutPage/team/Nadia Levi.webp";
import UNACVLogoImg from "@/assets/unacvancouver-blue-logo.png";
...
export const boardMembers: TeamMember[] = [
  ...
  },
  {
    ...
    image: UNACVLogoImg,
    bio: "Dariel began volunteering with UNAC–Vancouver in 2019, guided by a deep passion for human rights and education. Since then, she has been continually inspired by her fellow board members and the dedication of community volunteers. She runs a local tutoring agency that primarily supports newcomers to Canada from South Korea, and this work inspired her to pursue a Master in Public Policy and Global Affairs from UBC, with the hope of contributing to a more diverse and compassionate future. Through her work, Dariel aims to advocate for minority rights, equitable access to education and employment, and meaningful solidarity across gender, race, and income.\n\nIn the years since joining UNAC–V, Dariel has also worked closely with UNA-Canada on several impactful initiatives such as the Digital Equity and Eco Clubs Programmes; experiences she is eager to share with the next generation of changemakers. As Co-Vice President, her goal is to create more accessible pathways for the Vancouver community to engage with United Nations initiatives. She warmly encourages anyone interested in global advocacy to connect with the Vancouver branch, believing that when people come together and value their differences, real and lasting change becomes possible!",
    email: "dariel.filwood@unacvancouver.org",
    linkedin: "https://ca.linkedin.com/in/dariel-filwood",
  },
  {
    id: 3,
    name: "Juan Sebastian Mateus",
    role: "Co-Vice President",
    image: JuanSebastianMateusImg,
    bio: "Sebastian was born and raised in Bogotá, Colombia, and moved to Vancouver, Canada, in 2022. He holds an MSc in Development from the University of Los Andes and brings over 10 years of experience in corporate sustainability. His career includes work with extractive industries and rural communities across Latin America, where he implemented human rights due diligence and supported community-led investment strategies.\n\nSebastian also spent three years with the United Nations Development Programme in Colombia, advancing supplier development initiatives that created opportunities for small businesses led by vulnerable communities. He is passionate about empowering resilient entrepreneurs operating in complex environments, helping them access growth opportunities that promote equitable and inclusive economic development.\n\nCurrently, Sebastian volunteers with UNAC-Vancouver, where he works to inspire young leaders to adopt inclusive and environmentally responsible business practices.",
    email: "Juan.Sebastian.Mateus@unacvancouver.org",
    linkedin: "https://www.linkedin.com/in/juan-sebastian-mateus/",
  },
  {
    id: 4,
    name: "Rosio Godomar",
    role: "Treasurer",
    image: RosioGodomarImg,
  ...
  },
  {
    ...
    bio: "Sameer Esmail is a transportation and aviation professional who is passionate about policy modernization and improving mobility for all. Sameer holds a Master of Management and a Bachelor of Arts in International Relations from the University of British Columbia. In addition to his passion for aviation and travel, Sameer is also interested in the future of work, responsible AI use, and international relations. Sameer currently works at InterVISTAS Consulting in Vancouver and previously held in various roles in the public sector. Sameer was President of the UNAC-Vancouver Board of Directors from 2022 to 2025.\n\nSameer was Canada's Head Delegate to the 2022 G20 Youth Summit in Indonesia, playing a key role in drafting the Y20 Communique that was presented to G20 leaders. Sameer also represented Canadian youth at the 2021 OECD Forum with Young Diplomats of Canada. Sameer is currently a member of the alumniUBC Advisory Council. He previously served as a member of the Greater Vancouver Board of Trade's Leaders of Tomorrow program and Asia-Pacific Foundation of Canada's Canada-Asia Young Fellows program.",
    linkedin: "https://www.linkedin.com/in/sameeresmail/",
  },
  {
    id: 6,
    name: "Jessica Steele",
    role: "Director-at-Large",
    image: JessicaSteeleImg,
    bio: "Jessica Steele (she/her) was born in France, grew up in Victoria, and now lives in Squamish BC, the traditional territory of the Sḵwx̱wú7mesh Úxwumixw. Jessica holds a BSc in Biology (Specialization in Marine Biology) from the University of Victoria and a Master's of Resource Management (Coastal and Marine Management) from the University of Akureyri. She has worked with non-profits, Indigenous government, and academic institutions in a wide range of areas including research, natural resource management, marine restoration, environmental policy, and youth engagement. Her work has taken her across Canada as well as overseas in Australia, Senegal, and Iceland. She is currently a Project Coordinator with SeaChange Marine Conservation Society supporting the Resilient Estuaries of the Salish Sea project. Prior to this role, Jessica was the Consultation and Accommodation Manager and Natural Resources Planning Manager for Tsleil-Waututh Nation.\n\nJessica has served on the UNAC-Vancouver board since 2017 in various roles including Co-Vice-President and Co-President. She was a delegate to the UNFCCC COP24 (KAIROS Canada) in 2018 and the UN Oceans Conference (Tsleil-Waututh Nation; British Columbia Council for International Cooperation) in 2022. Jessica loves jumping in the ocean, hiking, birding, singing, and playing the piano.",
    linkedin: "https://www.linkedin.com/in/jessicaajsteele/",
  },
  {
    id: 7,
    name: "Soon-Lan Lee Switzer",
    role: "Director at Large",
    image: SoonLanLeeSwitzerImg,
    bio: "Sue is an award-winning educator, National Certified Career Development Practitioner (CCDP®), and community leader with over a decade of experience in career development and vocational education across secondary and post-secondary frameworks. She holds a Master of Arts in Higher Education Administration and Leadership, along with professional credentials in career development practice, human resources management, and essential skills training.\n\nAs a learner-centred instructor and conference speaker, her work focuses on the quality of student learning and the learner experience, with a strong emphasis on inclusive, engaging, and practical education. She believes learning should be active and meaningful—much like a playground—where educators create safe environments that empower learners to explore and build confidence in their own abilities.\n\nShe was involved in the SDGs Research Project for k-12 teachers with KPU. Through her teaching, public speaking, and community leadership, Sue remains deeply committed to advancing equity, global citizenship, and the principles of the United Nations Sustainable Development Goals (2030).",
    email: "soonlan.switzer@unacvancouver.org",
...
export const advisoryMembers: TeamMember[] = [
  ...
  },
  {
    ...
    image: UNACVLogoImg,
    bio: "As member of the Advisory Council of the United Nations Association in Canada, Alfred Lai brings a distinctive blend of public service, governance experience, and entrepreneurial leadership to advancing global citizenship and the United Nations Sustainable Development Goals.\n\nAlfred currently serves as a Heritage Commissioner for the City of Vancouver, where he advises on the protection of cultural and architectural legacy while balancing inclusive growth and community development. He also worked as Chief of Staff in the House of Commons of Canada, where he supported legislative priorities, stakeholder engagement, and policy initiatives at the national level. This experience shaped his understanding of federal governance, diplomacy, and the importance of NGO institutions in creating long-term social impacts.\n\nAn award-winning entrepreneur, Alfred also led a food franchise group that generated more than 150 million dollars in revenue over the past five years. He also completed postgraduate studies at Saïd Business School, University of Oxford, where he developed a global perspective on addressing some of the major challenges facing humanity in the 21st century.\n\nDeeply committed to addressing digital inequality, Alfred advocates for equitable access to technology as a foundation for education, economic opportunity, and sustainable development. Believing that inclusive systems and international cooperation drive lasting change, Alfred welcomes all Vancouverites to join in advancing a more just and resilient world.",
    email: "alfred.lai@unacvancouver.org",
  },
  {
    id: 3,
    name: "Axel Velasquez",
    role: "Advisory Council",
    image: UNACVLogoImg, // TODO: Replace with actual image
