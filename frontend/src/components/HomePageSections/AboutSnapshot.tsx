...
export default function AboutSnapshot() {
    return (
        <section 
            id="about-snapshot" 
            className="bg-[var(--color-neutral-0)] w-full flex flex-col items-center px-[24px] md:px-[75px] lg:px-[150px] py-[40px] md:py-[60px] lg:py-[75px]"
        >
            <div className="flex flex-col lg:flex-row gap-[40px] lg:gap-[100px] items-start justify-center w-full">
                ...
                <div className="flex-1 flex flex-col gap-[20px] items-start justify-center w-full">
                    ...
                    >
                        <span className="font-bold text-[18px] text-[var(--color-primary-blue-9)] tracking-[-0.1504px] leading-[20px] underline decoration-solid">
                            Learn More About Us
                        </span>
