...
export default function EventsPreview() {
    return (
        <section 
            id="events-preview" 
            className="bg-white w-full flex flex-col items-center px-[24px] md:px-[50px] lg:px-[75px] py-[50px] md:py-[65px] lg:py-[80px]"
        >
            <div className="flex flex-col gap-[50px] items-center w-full">
                {/* Header */}
                <div className="flex flex-col gap-[20px] items-center w-full">
                    <H3 className="text-[#0c193d] text-center">
                        Upcoming Events
                    </H3>
                    <div className="text-center px-[9px]">
                        <Body className="text-[#2e2e2e]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[30px] md:gap-[40px] w-full">
                    {EVENTS.map((event) => (
                        <div 
                            key={event.id}
                            className="border border-[#e8edff] rounded-[10px] flex flex-col overflow-hidden hover:shadow-lg transition-shadow"
                        >
                            {/* Event Image */}
                            ...
                            <div className="flex flex-col gap-[12px] p-[15px_15px_25px_15px]">
                                ...
                                <div className="flex flex-col gap-[16px]">
                                    <span className="bg-[#f6f8fd] px-[9px] py-[2px] rounded-[5px] text-[12px] font-medium text-[#0f1f4c] leading-[16px] w-fit">
                                        {event.category}
                                    </span>
                                    <h4 className="font-semibold text-[18px] text-[#0c193d] tracking-[-0.3125px] leading-[16px]">
                                        {event.title}
                                    </h4>
                                </div>
                                ...
                                <div className="flex flex-col gap-[16px]">
                                    <div className="flex flex-col gap-[4px]">
                                        ...
                                        <div className="flex gap-[8px] items-center h-[24px]">
                                            ...
                                            <BodySmall className="text-[#404040] leading-[24px]">
                                                {event.date}
                                            </BodySmall>
                                        </div>
                                        {/* Time */}
                                    ...
                                    <div className="flex flex-col gap-[8px]">
                                        ...
                                        <a 
                                            ...
                                            className="text-[12px] font-medium text-[#162d6e] underline decoration-solid leading-[20px] tracking-[-0.1504px] hover:opacity-80 transition-opacity"
                                        >
                                            Learn More
                                        </a>
                                    </div>
                ...
                >
                    <span className="font-bold text-[18px] text-[#0f1f4c] tracking-[-0.1504px] leading-[20px] underline decoration-solid">
                        See All Events
                    </span>
